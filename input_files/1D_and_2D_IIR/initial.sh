...
python get_xyz.py
cp -r run_sample_"$nmol"_"$method" "$nmol"_"$method"/"$i"_0e-4
cp -r run_sample_"$nmol"_"$method" "$nmol"_"$method"/"$i"_4e-4
cp -r run_sample_"$nmol"_"$method" "$nmol"_"$method"/"$i"_7e-4
cp -r init_water_xyz_nvt "$nmol"_"$method"/"$i"_0e-4/data
cp -r init_water_xyz_nvt "$nmol"_"$method"/"$i"_4e-4/data
cp -r init_water_xyz_nvt "$nmol"_"$method"/"$i"_7e-4/data
rm -rf init_water_xyz_nvt
rm -rf simu.pos_0.xyz
sed -i "s/newE0=0/newE0=4/" "$nmol"_"$method"/"$i"_4e-4/summit.sh
